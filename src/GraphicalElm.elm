...
fieldAndEditorStateUpdatesPrivateDon'tUse =(\editFieldStates graphEditorState->(\efs ges -> {fieldState=efs,editorState=ges}) <~ editFieldStates~graphEditorState)editFieldStatesPrivateDon'tUse graphEditorStatePrivateDon'tUse{-_language_LiftElm_base_code_#####$#(\efs ges -> {fieldState=efs,editorState=ges}) <~#$#####_parents_editFieldStates,graphEditorState-}
...
editorEventsPrivateDon'tUse =(\editFieldEvents editButtonEvents movement applyKeyPress->merges [editButtonEvents,editFieldEvents,movement,applyKeyPress])editFieldEventsPrivateDon'tUse editButtonEventsPrivateDon'tUse movementPrivateDon'tUse applyKeyPressPrivateDon'tUse{-_language_ElmLang_base_code_#####$#merges [editButtonEvents,editFieldEvents,movement,applyKeyPress]#$#####_parents_editFieldEvents,editButtonEvents,movement,applyKeyPress-}
...
editFieldSPrivateDon'tUse =(\editFieldBuilderS fieldAndEditorStateUpdates->EditFields.editField <~ editFieldBuilderS ~ fieldAndEditorStateUpdates ~ WhatChanged.whatChanged editFieldBuilderS fieldAndEditorStateUpdates)editFieldBuilderSPrivateDon'tUse fieldAndEditorStateUpdatesPrivateDon'tUse{-_language_ElmLang_base_code_#####$#EditFields.editField <~ editFieldBuilderS ~ fieldAndEditorStateUpdates ~ WhatChanged.whatChanged editFieldBuilderS fieldAndEditorStateUpdates#$#####_parents_editFieldBuilderS,fieldAndEditorStateUpdates-}
